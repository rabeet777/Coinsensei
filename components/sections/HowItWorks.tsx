    ...
    <section id="how-it-works" className="section-py bg-[--color-surface]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          >
            Exchange USDT in 3 Simple Steps
          </motion.h2>
          <motion.p
          ...
          >
            Fast, safe, and guaranteed. All through the CoinSensei app.
          </motion.p>
        </div>
          ...
          {STEPS.map((step, i) => (
            ...
            >
              ...
              <motion.div
                ...
                className={`w-16 h-16 rounded-full ${i === 2 ? 'bg-green-600' : 'bg-[var(--color-primary)]'} text-white flex items-center justify-center font-[family-name:var(--font-manrope)] font-bold text-2xl mb-6 shadow-lg border-4 border-[--color-surface]`}
              >
                {step.n}
              </motion.div>

              {/* Icon */}
              <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-4 ${step.iconBg}`}>
